...
/**
 * LLM is currently unstable, and its API may change, or it may be removed, without a major version
 * bump.
 */
public class LLM implements Resource {
  ...
  /**
   * Space-separated list of model names this resource accepts. Requests for unlisted models are
   * rejected. Leave empty to allow all models.
   */
