...
public class GrantedRoleEntitlement {
  ...
  /**
   * The most recent time at which any account in the organization accessed this resource. Empty if
   * the resource has never been accessed.
   */
