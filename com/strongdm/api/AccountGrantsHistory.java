...
import com.strongdm.api.plumbing.AccountGrantsHistoryGrpc;
...
public class AccountGrantsHistory {
  ...
  /**
   * This function returns a copy of the AccountGrantsHistory service which has the given deadline
  ...
  public Iterable<AccountGrantHistory> list(String filter, Object... args) throws RpcException {
    AccountGrantsHistoryPlumbing.AccountGrantHistoryListRequest.Builder builder =
        AccountGrantsHistoryPlumbing.AccountGrantHistoryListRequest.newBuilder();
    ...
    Supplier<PageResult<AccountGrantHistory>> pageFetcher =
        () -> {
          // Note: this closure captures and reuses the builder to set the next page
          AccountGrantsHistoryPlumbing.AccountGrantHistoryListRequest req = builder.build();
          AccountGrantsHistoryPlumbing.AccountGrantHistoryListResponse plumbingResponse;
          int tries = 0;
          while (true) {
            try {
              plumbingResponse =
          ...
          List<AccountGrantHistory> page =
              Plumbing.convertRepeatedAccountGrantHistoryToPorcelain(
          ...
          return new PageResult<AccountGrantHistory>(page, hasNextCursor);
        };

    Iterator<AccountGrantHistory> iterator = new PageIterator<>(pageFetcher);
