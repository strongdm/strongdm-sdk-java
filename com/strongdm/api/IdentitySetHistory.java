...
/**
 * IdentitySetHistory records the state of a IdentitySet at a given point in time, where every
 * change (create, update and delete) to a IdentitySet produces an IdentitySetHistory record.
 */
public class IdentitySetHistory {
  private String activityId;
  /**
   * The unique identifier of the Activity that produced this change to the IdentitySet. May be
