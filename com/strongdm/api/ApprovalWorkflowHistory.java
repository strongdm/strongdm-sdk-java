...
/**
 * ApprovalWorkflowHistory records the state of an ApprovalWorkflow at a given point in time, where
 * every change (create, update and delete) to an ApprovalWorkflow produces an
 * ApprovalWorkflowHistory record.
 */
public class ApprovalWorkflowHistory {
  private String activityId;
  /**
   * The unique identifier of the Activity that produced this change to the ApprovalWorkflow. May be
