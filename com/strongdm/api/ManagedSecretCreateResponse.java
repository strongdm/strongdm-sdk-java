...
/**
 * ManagedSecretCreateResponse contains information about a Managed Secret after successful
 * creation.
 */
public class ManagedSecretCreateResponse {
  private ManagedSecret managedSecret;
  /** The requested Managed Secret. */
  public ManagedSecret getManagedSecret() {
    return this.managedSecret;
  }
  /** The requested Managed Secret. */
  public void setManagedSecret(ManagedSecret in) {
    this.managedSecret = in;
  }
