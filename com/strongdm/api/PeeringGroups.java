...
public class PeeringGroups {
  ...
  private PeeringGroups(
      PeeringGroupsGrpc.PeeringGroupsBlockingStub stub, Client client, Deadline deadline) {
    this.stub = stub;
    this.parent = client;
  ...
  public PeeringGroups withDeadlineAfter(long duration, TimeUnit units) {
    ...
    return new PeeringGroups(this.stub.withDeadline(deadline), this.parent, deadline);
  }
  ...
  public PeeringGroupCreateResponse create(PeeringGroup peeringGroup) throws RpcException {
    ...
    req = this.parent.getInterceptor().executeBefore("PeeringGroups.Create", req);
    ...
    plumbingResponse =
        this.parent.getInterceptor().executeAfter("PeeringGroups.Create", req, plumbingResponse);
  ...
  public PeeringGroupDeleteResponse delete(String id) throws RpcException {
    ...
    // Execute before interceptor hooks
    req = this.parent.getInterceptor().executeBefore("PeeringGroups.Delete", req);
    ...
    // Execute after interceptor hooks
    plumbingResponse =
        this.parent.getInterceptor().executeAfter("PeeringGroups.Delete", req, plumbingResponse);
  ...
  public PeeringGroupGetResponse get(String id) throws RpcException {
    ...
    // Execute before interceptor hooks
    req = this.parent.getInterceptor().executeBefore("PeeringGroups.Get", req);
    ...
    // Execute after interceptor hooks
    plumbingResponse =
        this.parent.getInterceptor().executeAfter("PeeringGroups.Get", req, plumbingResponse);
