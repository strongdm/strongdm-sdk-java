...
/**
 * AccountGroupHistory records the state of an AccountGroup at a given point in time, where every
 * change (create, update and delete) to an AccountGroup produces an AccountGroupHistory record.
 */
public class AccountGroupHistory {
  ...
  public void setAccountGroup(AccountGroup in) {
    this.accountGroup = in;
  }

  private String activityId;
  /**
   * The unique identifier of the Activity that produced this change to the AccountGroup. May be
