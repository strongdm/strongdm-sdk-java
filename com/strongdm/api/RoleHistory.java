...
/**
 * RoleHistory records the state of a Role at a given point in time, where every change (create,
 * update and delete) to a Role produces an RoleHistory record.
 */
public class RoleHistory {
  private String activityId;
  /**
   * The unique identifier of the Activity that produced this change to the Role. May be empty for
