...
public class AccountResourcesHistory {
  ...
  private AccountResourcesHistory(
      AccountResourcesHistoryGrpc.AccountResourcesHistoryBlockingStub stub,
      Client client,
      Deadline deadline) {
    this.stub = stub;
    this.parent = client;
  ...
  public AccountResourcesHistory withDeadlineAfter(long duration, TimeUnit units) {
    ...
    return new AccountResourcesHistory(this.stub.withDeadline(deadline), this.parent, deadline);
  }
