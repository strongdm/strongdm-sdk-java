...
/**
 * AccountHistory records the state of an Account at a given point in time, where every change
 * (create, update and delete) to an Account produces an AccountHistory record.
 */
public class AccountHistory {
  ...
  /**
   * The unique identifier of the Activity that produced this change to the Account. May be empty
