...
public class KeyfactorX509Store implements SecretStore {
  ...
  private String keyPasswordEnvVar;
  /** optional environment variable housing the password that is used to decrypt the key file. */
  public String getKeyPasswordEnvVar() {
    return this.keyPasswordEnvVar;
  }
  /** optional environment variable housing the password that is used to decrypt the key file. */
  public void setKeyPasswordEnvVar(String in) {
    this.keyPasswordEnvVar = in;
  }
