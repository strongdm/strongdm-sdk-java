...
public class AccountsHistory {
  ...
  private AccountsHistory(
      AccountsHistoryGrpc.AccountsHistoryBlockingStub stub, Client client, Deadline deadline) {
    this.stub = stub;
    this.parent = client;
  ...
  public AccountsHistory withDeadlineAfter(long duration, TimeUnit units) {
    ...
    return new AccountsHistory(this.stub.withDeadline(deadline), this.parent, deadline);
  }
