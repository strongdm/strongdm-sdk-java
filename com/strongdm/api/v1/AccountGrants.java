...
AccountGrantsPlumbing.AccountGrantCreateRequest.Builder builder = AccountGrantsPlumbing.AccountGrantCreateRequest.newBuilder();
...
AccountGrantsPlumbing.AccountGrantCreateRequest req = builder.build();
        ...
        while (true) {
            try {
                plumbingResponse = this.stub.withCallCredentials(this.parent.getCallCredentials("AccountGrants.Create", req)).create(req);
            } catch(Exception e) {
...
AccountGrantsPlumbing.AccountGrantGetRequest.Builder builder = AccountGrantsPlumbing.AccountGrantGetRequest.newBuilder();
                    builder.setId((id));
AccountGrantsPlumbing.AccountGrantGetRequest req = builder.build();
        ...
        while (true) {
            try {
                plumbingResponse = this.stub.withCallCredentials(this.parent.getCallCredentials("AccountGrants.Get", req)).get(req);
            } catch(Exception e) {
                if (this.parent.shouldRetry(tries, e)) {
                    tries++;
                    this.parent.jitterSleep(tries);
...
AccountGrantsPlumbing.AccountGrantDeleteRequest.Builder builder = AccountGrantsPlumbing.AccountGrantDeleteRequest.newBuilder();
                    builder.setId((id));
AccountGrantsPlumbing.AccountGrantDeleteRequest req = builder.build();
        ...
        while (true) {
            try {
                plumbingResponse = this.stub.withCallCredentials(this.parent.getCallCredentials("AccountGrants.Delete", req)).delete(req);
            } catch(Exception e) {
                if (this.parent.shouldRetry(tries, e)) {
                    tries++;
                    this.parent.jitterSleep(tries);
    ...
    public
    Iterable<AccountGrant>
    list(
      String
      filter
    , Object... args
    ) throws RpcException {
    AccountGrantsPlumbing.AccountGrantListRequest.Builder builder = AccountGrantsPlumbing.AccountGrantListRequest.newBuilder();
        ...
        Supplier<PageResult<AccountGrant> > pageFetcher = () -> {
            ...
            plumbingResponse = this.stub.withCallCredentials(this.parent.getCallCredentials("AccountGrants.List", req)).list(req);

            List<AccountGrant> page =
                Plumbing.convertRepeatedAccountGrantToPorcelain(plumbingResponse.getAccountGrantsList());
