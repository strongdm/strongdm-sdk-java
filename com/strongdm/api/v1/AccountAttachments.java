...
public class AccountAttachments {
    ...
    private AccountAttachments(AccountAttachmentsGrpc.AccountAttachmentsBlockingStub stub, Client client) {
        this.stub = stub;
        this.parent = client;
    }
...
AccountAttachmentsPlumbing.AccountAttachmentCreateRequest.Builder builder = AccountAttachmentsPlumbing.AccountAttachmentCreateRequest.newBuilder();
...
AccountAttachmentsPlumbing.AccountAttachmentCreateRequest req = builder.build();
        ...
        while (true) {
            try {
                plumbingResponse = this.stub.withCallCredentials(this.parent.getCallCredentials("AccountAttachments.Create", req)).create(req);
            } catch(Exception e) {
...
AccountAttachmentsPlumbing.AccountAttachmentGetRequest.Builder builder = AccountAttachmentsPlumbing.AccountAttachmentGetRequest.newBuilder();
                    builder.setId((id));
AccountAttachmentsPlumbing.AccountAttachmentGetRequest req = builder.build();
        ...
        while (true) {
            try {
                plumbingResponse = this.stub.withCallCredentials(this.parent.getCallCredentials("AccountAttachments.Get", req)).get(req);
            } catch(Exception e) {
                if (this.parent.shouldRetry(tries, e)) {
                    tries++;
                    this.parent.jitterSleep(tries);
...
AccountAttachmentsPlumbing.AccountAttachmentDeleteRequest.Builder builder = AccountAttachmentsPlumbing.AccountAttachmentDeleteRequest.newBuilder();
                    builder.setId((id));
AccountAttachmentsPlumbing.AccountAttachmentDeleteRequest req = builder.build();
        ...
        while (true) {
            try {
                plumbingResponse = this.stub.withCallCredentials(this.parent.getCallCredentials("AccountAttachments.Delete", req)).delete(req);
            } catch(Exception e) {
                if (this.parent.shouldRetry(tries, e)) {
                    tries++;
                    this.parent.jitterSleep(tries);
    ...
    public
    Iterable<AccountAttachment>
    list(
      String
      filter
    , Object... args
    ) throws RpcException {
    AccountAttachmentsPlumbing.AccountAttachmentListRequest.Builder builder = AccountAttachmentsPlumbing.AccountAttachmentListRequest.newBuilder();
        ...
        Supplier<PageResult<AccountAttachment> > pageFetcher = () -> {
            ...
            plumbingResponse = this.stub.withCallCredentials(this.parent.getCallCredentials("AccountAttachments.List", req)).list(req);

            List<AccountAttachment> page =
                Plumbing.convertRepeatedAccountAttachmentToPorcelain(plumbingResponse.getAccountAttachmentsList());
