...
NodesPlumbing.NodeCreateRequest req = builder.build();
        ...
        while (true) {
            try {
                plumbingResponse = this.stub.withCallCredentials(this.parent.getCallCredentials("Nodes.Create", req)).create(req);
            } catch(Exception e) {
...
NodesPlumbing.NodeGetRequest req = builder.build();
        ...
        while (true) {
            try {
                plumbingResponse = this.stub.withCallCredentials(this.parent.getCallCredentials("Nodes.Get", req)).get(req);
            } catch(Exception e) {
                if (this.parent.shouldRetry(tries, e)) {
                    tries++;
                    this.parent.jitterSleep(tries);
...
NodesPlumbing.NodeUpdateRequest req = builder.build();
        ...
        while (true) {
            try {
                plumbingResponse = this.stub.withCallCredentials(this.parent.getCallCredentials("Nodes.Update", req)).update(req);
            } catch(Exception e) {
                if (this.parent.shouldRetry(tries, e)) {
                    tries++;
                    this.parent.jitterSleep(tries);
...
NodesPlumbing.NodeDeleteRequest req = builder.build();
        ...
        while (true) {
            try {
                plumbingResponse = this.stub.withCallCredentials(this.parent.getCallCredentials("Nodes.Delete", req)).delete(req);
            } catch(Exception e) {
                if (this.parent.shouldRetry(tries, e)) {
                    tries++;
                    this.parent.jitterSleep(tries);
    ...
    NodesPlumbing.NodeListRequest.Builder builder = NodesPlumbing.NodeListRequest.newBuilder();
        ...
        Supplier<PageResult<Node> > pageFetcher = () -> {
            ...
            plumbingResponse = this.stub.withCallCredentials(this.parent.getCallCredentials("Nodes.List", req)).list(req);
