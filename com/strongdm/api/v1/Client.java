...
public class Client {
    ...
    public Client(String apiAccessKey, String apiSecretKey, ClientOptions options) throws RpcException {
        ...
        try {
            NettyChannelBuilder builder = NettyChannelBuilder.forAddress(options.getHost(), options.getPort());
