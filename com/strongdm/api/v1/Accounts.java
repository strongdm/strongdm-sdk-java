...
AccountsPlumbing.AccountCreateRequest.Builder builder = AccountsPlumbing.AccountCreateRequest.newBuilder();
...
AccountsPlumbing.AccountCreateRequest req = builder.build();
        ...
        while (true) {
            try {
                plumbingResponse = this.stub.withCallCredentials(this.parent.getCallCredentials("Accounts.Create", req)).create(req);
            } catch(Exception e) {
...
AccountsPlumbing.AccountGetRequest.Builder builder = AccountsPlumbing.AccountGetRequest.newBuilder();
                    builder.setId((id));
AccountsPlumbing.AccountGetRequest req = builder.build();
        ...
        while (true) {
            try {
                plumbingResponse = this.stub.withCallCredentials(this.parent.getCallCredentials("Accounts.Get", req)).get(req);
            } catch(Exception e) {
                if (this.parent.shouldRetry(tries, e)) {
                    tries++;
                    this.parent.jitterSleep(tries);
...
AccountsPlumbing.AccountUpdateRequest.Builder builder = AccountsPlumbing.AccountUpdateRequest.newBuilder();
                    builder.setAccount(Plumbing.convertAccountToPlumbing(account));
AccountsPlumbing.AccountUpdateRequest req = builder.build();
        ...
        while (true) {
            try {
                plumbingResponse = this.stub.withCallCredentials(this.parent.getCallCredentials("Accounts.Update", req)).update(req);
            } catch(Exception e) {
                if (this.parent.shouldRetry(tries, e)) {
                    tries++;
                    this.parent.jitterSleep(tries);
...
AccountsPlumbing.AccountDeleteRequest.Builder builder = AccountsPlumbing.AccountDeleteRequest.newBuilder();
                    builder.setId((id));
AccountsPlumbing.AccountDeleteRequest req = builder.build();
        ...
        while (true) {
            try {
                plumbingResponse = this.stub.withCallCredentials(this.parent.getCallCredentials("Accounts.Delete", req)).delete(req);
            } catch(Exception e) {
                if (this.parent.shouldRetry(tries, e)) {
                    tries++;
                    this.parent.jitterSleep(tries);
    ...
    AccountsPlumbing.AccountListRequest.Builder builder = AccountsPlumbing.AccountListRequest.newBuilder();
        ...
        Supplier<PageResult<Account> > pageFetcher = () -> {
            ...
            plumbingResponse = this.stub.withCallCredentials(this.parent.getCallCredentials("Accounts.List", req)).list(req);
