...
public class Plumbing {
    ...
    public static String quoteFilterArgs(String filter, Object... args) throws BadRequestException {
        String[] parts = (filter+" ").split("\\?"); // trailing space to stop split from discarding last match
    ...
    public static Tags convertTagsToPlumbing(java.util.Map<String, String> porcelain) {
        ...
        for (java.util.Map.Entry<String, String> entry : porcelain.entrySet()) {
            builder.addPairs(Tags.Pair.newBuilder().setName(entry.getKey()).setValue(entry.getValue()).build());
        }
        return builder.build();
    }
    public static com.strongdm.api.v1.CreateResponseMetadata convertCreateResponseMetadataToPorcelain(CreateResponseMetadata plumbing) {
        com.strongdm.api.v1.CreateResponseMetadata porcelain = new com.strongdm.api.v1.CreateResponseMetadata();
        return porcelain;
    }

    public static CreateResponseMetadata convertCreateResponseMetadataToPlumbing(com.strongdm.api.v1.CreateResponseMetadata porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.CreateResponseMetadata> convertRepeatedCreateResponseMetadataToPorcelain(Collection<CreateResponseMetadata> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertCreateResponseMetadataToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<CreateResponseMetadata> convertRepeatedCreateResponseMetadataToPlumbing(Collection<com.strongdm.api.v1.CreateResponseMetadata> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertCreateResponseMetadataToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.GetResponseMetadata convertGetResponseMetadataToPorcelain(GetResponseMetadata plumbing) {
        com.strongdm.api.v1.GetResponseMetadata porcelain = new com.strongdm.api.v1.GetResponseMetadata();
        return porcelain;
    }

    public static GetResponseMetadata convertGetResponseMetadataToPlumbing(com.strongdm.api.v1.GetResponseMetadata porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.GetResponseMetadata> convertRepeatedGetResponseMetadataToPorcelain(Collection<GetResponseMetadata> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertGetResponseMetadataToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<GetResponseMetadata> convertRepeatedGetResponseMetadataToPlumbing(Collection<com.strongdm.api.v1.GetResponseMetadata> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertGetResponseMetadataToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.UpdateResponseMetadata convertUpdateResponseMetadataToPorcelain(UpdateResponseMetadata plumbing) {
        com.strongdm.api.v1.UpdateResponseMetadata porcelain = new com.strongdm.api.v1.UpdateResponseMetadata();
        return porcelain;
    }

    public static UpdateResponseMetadata convertUpdateResponseMetadataToPlumbing(com.strongdm.api.v1.UpdateResponseMetadata porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.UpdateResponseMetadata> convertRepeatedUpdateResponseMetadataToPorcelain(Collection<UpdateResponseMetadata> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertUpdateResponseMetadataToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<UpdateResponseMetadata> convertRepeatedUpdateResponseMetadataToPlumbing(Collection<com.strongdm.api.v1.UpdateResponseMetadata> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertUpdateResponseMetadataToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.DeleteResponseMetadata convertDeleteResponseMetadataToPorcelain(DeleteResponseMetadata plumbing) {
        com.strongdm.api.v1.DeleteResponseMetadata porcelain = new com.strongdm.api.v1.DeleteResponseMetadata();
        return porcelain;
    }

    public static DeleteResponseMetadata convertDeleteResponseMetadataToPlumbing(com.strongdm.api.v1.DeleteResponseMetadata porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.DeleteResponseMetadata> convertRepeatedDeleteResponseMetadataToPorcelain(Collection<DeleteResponseMetadata> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertDeleteResponseMetadataToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<DeleteResponseMetadata> convertRepeatedDeleteResponseMetadataToPlumbing(Collection<com.strongdm.api.v1.DeleteResponseMetadata> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertDeleteResponseMetadataToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.RateLimitMetadata convertRateLimitMetadataToPorcelain(RateLimitMetadata plumbing) {
    ...
    public static RateLimitMetadata convertRateLimitMetadataToPlumbing(com.strongdm.api.v1.RateLimitMetadata porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.RateLimitMetadata> convertRepeatedRateLimitMetadataToPorcelain(Collection<RateLimitMetadata> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertRateLimitMetadataToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<RateLimitMetadata> convertRepeatedRateLimitMetadataToPlumbing(Collection<com.strongdm.api.v1.RateLimitMetadata> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertRateLimitMetadataToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.AccountAttachmentCreateResponse convertAccountAttachmentCreateResponseToPorcelain(AccountAttachmentCreateResponse plumbing) {
        com.strongdm.api.v1.AccountAttachmentCreateResponse porcelain = new com.strongdm.api.v1.AccountAttachmentCreateResponse();
        porcelain.setMeta(Plumbing.convertCreateResponseMetadataToPorcelain(plumbing.getMeta()));
        porcelain.setAccountAttachment(Plumbing.convertAccountAttachmentToPorcelain(plumbing.getAccountAttachment()));
        porcelain.setRateLimit(Plumbing.convertRateLimitMetadataToPorcelain(plumbing.getRateLimit()));
        return porcelain;
    }

    public static AccountAttachmentCreateResponse convertAccountAttachmentCreateResponseToPlumbing(com.strongdm.api.v1.AccountAttachmentCreateResponse porcelain) {
        if (porcelain == null) {
            return null;
        }
        ...
        if (porcelain.getAccountAttachment() != null) {
            builder.setAccountAttachment(Plumbing.convertAccountAttachmentToPlumbing(porcelain.getAccountAttachment()));
        }
    ...
    public static List<com.strongdm.api.v1.AccountAttachmentCreateResponse> convertRepeatedAccountAttachmentCreateResponseToPorcelain(Collection<AccountAttachmentCreateResponse> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertAccountAttachmentCreateResponseToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<AccountAttachmentCreateResponse> convertRepeatedAccountAttachmentCreateResponseToPlumbing(Collection<com.strongdm.api.v1.AccountAttachmentCreateResponse> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertAccountAttachmentCreateResponseToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.AccountAttachmentGetResponse convertAccountAttachmentGetResponseToPorcelain(AccountAttachmentGetResponse plumbing) {
        com.strongdm.api.v1.AccountAttachmentGetResponse porcelain = new com.strongdm.api.v1.AccountAttachmentGetResponse();
    ...
    public static AccountAttachmentGetResponse convertAccountAttachmentGetResponseToPlumbing(com.strongdm.api.v1.AccountAttachmentGetResponse porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.AccountAttachmentGetResponse> convertRepeatedAccountAttachmentGetResponseToPorcelain(Collection<AccountAttachmentGetResponse> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertAccountAttachmentGetResponseToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<AccountAttachmentGetResponse> convertRepeatedAccountAttachmentGetResponseToPlumbing(Collection<com.strongdm.api.v1.AccountAttachmentGetResponse> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertAccountAttachmentGetResponseToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.AccountAttachmentDeleteResponse convertAccountAttachmentDeleteResponseToPorcelain(AccountAttachmentDeleteResponse plumbing) {
        com.strongdm.api.v1.AccountAttachmentDeleteResponse porcelain = new com.strongdm.api.v1.AccountAttachmentDeleteResponse();
        porcelain.setMeta(Plumbing.convertDeleteResponseMetadataToPorcelain(plumbing.getMeta()));
        porcelain.setRateLimit(Plumbing.convertRateLimitMetadataToPorcelain(plumbing.getRateLimit()));
        return porcelain;
    }

    public static AccountAttachmentDeleteResponse convertAccountAttachmentDeleteResponseToPlumbing(com.strongdm.api.v1.AccountAttachmentDeleteResponse porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.AccountAttachmentDeleteResponse> convertRepeatedAccountAttachmentDeleteResponseToPorcelain(Collection<AccountAttachmentDeleteResponse> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertAccountAttachmentDeleteResponseToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<AccountAttachmentDeleteResponse> convertRepeatedAccountAttachmentDeleteResponseToPlumbing(Collection<com.strongdm.api.v1.AccountAttachmentDeleteResponse> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertAccountAttachmentDeleteResponseToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.AccountAttachment convertAccountAttachmentToPorcelain(AccountAttachment plumbing) {
    ...
    public static AccountAttachment convertAccountAttachmentToPlumbing(com.strongdm.api.v1.AccountAttachment porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.AccountAttachment> convertRepeatedAccountAttachmentToPorcelain(Collection<AccountAttachment> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertAccountAttachmentToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<AccountAttachment> convertRepeatedAccountAttachmentToPlumbing(Collection<com.strongdm.api.v1.AccountAttachment> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertAccountAttachmentToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.AccountGrantCreateResponse convertAccountGrantCreateResponseToPorcelain(AccountGrantCreateResponse plumbing) {
        com.strongdm.api.v1.AccountGrantCreateResponse porcelain = new com.strongdm.api.v1.AccountGrantCreateResponse();
        porcelain.setMeta(Plumbing.convertCreateResponseMetadataToPorcelain(plumbing.getMeta()));
    ...
    public static AccountGrantCreateResponse convertAccountGrantCreateResponseToPlumbing(com.strongdm.api.v1.AccountGrantCreateResponse porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.AccountGrantCreateResponse> convertRepeatedAccountGrantCreateResponseToPorcelain(Collection<AccountGrantCreateResponse> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertAccountGrantCreateResponseToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<AccountGrantCreateResponse> convertRepeatedAccountGrantCreateResponseToPlumbing(Collection<com.strongdm.api.v1.AccountGrantCreateResponse> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertAccountGrantCreateResponseToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.AccountGrantGetResponse convertAccountGrantGetResponseToPorcelain(AccountGrantGetResponse plumbing) {
        com.strongdm.api.v1.AccountGrantGetResponse porcelain = new com.strongdm.api.v1.AccountGrantGetResponse();
        porcelain.setMeta(Plumbing.convertGetResponseMetadataToPorcelain(plumbing.getMeta()));
        porcelain.setAccountGrant(Plumbing.convertAccountGrantToPorcelain(plumbing.getAccountGrant()));
        porcelain.setRateLimit(Plumbing.convertRateLimitMetadataToPorcelain(plumbing.getRateLimit()));
        return porcelain;
    ...
    public static AccountGrantGetResponse convertAccountGrantGetResponseToPlumbing(com.strongdm.api.v1.AccountGrantGetResponse porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.AccountGrantGetResponse> convertRepeatedAccountGrantGetResponseToPorcelain(Collection<AccountGrantGetResponse> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertAccountGrantGetResponseToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<AccountGrantGetResponse> convertRepeatedAccountGrantGetResponseToPlumbing(Collection<com.strongdm.api.v1.AccountGrantGetResponse> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertAccountGrantGetResponseToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.AccountGrantDeleteResponse convertAccountGrantDeleteResponseToPorcelain(AccountGrantDeleteResponse plumbing) {
        com.strongdm.api.v1.AccountGrantDeleteResponse porcelain = new com.strongdm.api.v1.AccountGrantDeleteResponse();
        porcelain.setMeta(Plumbing.convertDeleteResponseMetadataToPorcelain(plumbing.getMeta()));
        porcelain.setRateLimit(Plumbing.convertRateLimitMetadataToPorcelain(plumbing.getRateLimit()));
        return porcelain;
    }

    public static AccountGrantDeleteResponse convertAccountGrantDeleteResponseToPlumbing(com.strongdm.api.v1.AccountGrantDeleteResponse porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.AccountGrantDeleteResponse> convertRepeatedAccountGrantDeleteResponseToPorcelain(Collection<AccountGrantDeleteResponse> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertAccountGrantDeleteResponseToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<AccountGrantDeleteResponse> convertRepeatedAccountGrantDeleteResponseToPlumbing(Collection<com.strongdm.api.v1.AccountGrantDeleteResponse> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertAccountGrantDeleteResponseToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.AccountGrant convertAccountGrantToPorcelain(AccountGrant plumbing) {
    ...
    public static AccountGrant convertAccountGrantToPlumbing(com.strongdm.api.v1.AccountGrant porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.AccountGrant> convertRepeatedAccountGrantToPorcelain(Collection<AccountGrant> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertAccountGrantToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<AccountGrant> convertRepeatedAccountGrantToPlumbing(Collection<com.strongdm.api.v1.AccountGrant> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertAccountGrantToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.AccountCreateResponse convertAccountCreateResponseToPorcelain(AccountCreateResponse plumbing) {
        com.strongdm.api.v1.AccountCreateResponse porcelain = new com.strongdm.api.v1.AccountCreateResponse();
        porcelain.setMeta(Plumbing.convertCreateResponseMetadataToPorcelain(plumbing.getMeta()));
    ...
    public static AccountCreateResponse convertAccountCreateResponseToPlumbing(com.strongdm.api.v1.AccountCreateResponse porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.AccountCreateResponse> convertRepeatedAccountCreateResponseToPorcelain(Collection<AccountCreateResponse> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertAccountCreateResponseToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<AccountCreateResponse> convertRepeatedAccountCreateResponseToPlumbing(Collection<com.strongdm.api.v1.AccountCreateResponse> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertAccountCreateResponseToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.AccountGetResponse convertAccountGetResponseToPorcelain(AccountGetResponse plumbing) {
    ...
    public static AccountGetResponse convertAccountGetResponseToPlumbing(com.strongdm.api.v1.AccountGetResponse porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.AccountGetResponse> convertRepeatedAccountGetResponseToPorcelain(Collection<AccountGetResponse> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertAccountGetResponseToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<AccountGetResponse> convertRepeatedAccountGetResponseToPlumbing(Collection<com.strongdm.api.v1.AccountGetResponse> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertAccountGetResponseToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.AccountUpdateResponse convertAccountUpdateResponseToPorcelain(AccountUpdateResponse plumbing) {
        com.strongdm.api.v1.AccountUpdateResponse porcelain = new com.strongdm.api.v1.AccountUpdateResponse();
    ...
    public static AccountUpdateResponse convertAccountUpdateResponseToPlumbing(com.strongdm.api.v1.AccountUpdateResponse porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.AccountUpdateResponse> convertRepeatedAccountUpdateResponseToPorcelain(Collection<AccountUpdateResponse> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertAccountUpdateResponseToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<AccountUpdateResponse> convertRepeatedAccountUpdateResponseToPlumbing(Collection<com.strongdm.api.v1.AccountUpdateResponse> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertAccountUpdateResponseToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.AccountDeleteResponse convertAccountDeleteResponseToPorcelain(AccountDeleteResponse plumbing) {
        com.strongdm.api.v1.AccountDeleteResponse porcelain = new com.strongdm.api.v1.AccountDeleteResponse();
        porcelain.setMeta(Plumbing.convertDeleteResponseMetadataToPorcelain(plumbing.getMeta()));
        porcelain.setRateLimit(Plumbing.convertRateLimitMetadataToPorcelain(plumbing.getRateLimit()));
        return porcelain;
    }

    public static AccountDeleteResponse convertAccountDeleteResponseToPlumbing(com.strongdm.api.v1.AccountDeleteResponse porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.AccountDeleteResponse> convertRepeatedAccountDeleteResponseToPorcelain(Collection<AccountDeleteResponse> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertAccountDeleteResponseToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<AccountDeleteResponse> convertRepeatedAccountDeleteResponseToPlumbing(Collection<com.strongdm.api.v1.AccountDeleteResponse> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.Account> convertRepeatedAccountToPorcelain(Collection<Account> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertAccountToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<Account> convertRepeatedAccountToPlumbing(Collection<com.strongdm.api.v1.Account> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.User> convertRepeatedUserToPorcelain(Collection<User> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertUserToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<User> convertRepeatedUserToPlumbing(Collection<com.strongdm.api.v1.User> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.Service> convertRepeatedServiceToPorcelain(Collection<Service> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertServiceToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<Service> convertRepeatedServiceToPlumbing(Collection<com.strongdm.api.v1.Service> porcelains) {
        return porcelains.stream()
    ...
    public static Resource convertResourceToPlumbing(com.strongdm.api.v1.Resource porcelain) {
        ...
        if (porcelain instanceof com.strongdm.api.v1.HTTPBasicAuth) {
            Resource.Builder builder = Resource.newBuilder();
            builder.setHttpBasicAuth(convertHTTPBasicAuthToPlumbing((com.strongdm.api.v1.HTTPBasicAuth)porcelain));
            return builder.build();
        }
        if (porcelain instanceof com.strongdm.api.v1.HTTPNoAuth) {
            Resource.Builder builder = Resource.newBuilder();
            builder.setHttpNoAuth(convertHTTPNoAuthToPlumbing((com.strongdm.api.v1.HTTPNoAuth)porcelain));
            return builder.build();
        }
        ...
        if (porcelain instanceof com.strongdm.api.v1.Kubernetes) {
            Resource.Builder builder = Resource.newBuilder();
            builder.setKubernetes(convertKubernetesToPlumbing((com.strongdm.api.v1.Kubernetes)porcelain));
            return builder.build();
        }
        if (porcelain instanceof com.strongdm.api.v1.KubernetesBasicAuth) {
            Resource.Builder builder = Resource.newBuilder();
            builder.setKubernetesBasicAuth(convertKubernetesBasicAuthToPlumbing((com.strongdm.api.v1.KubernetesBasicAuth)porcelain));
            return builder.build();
        }
        if (porcelain instanceof com.strongdm.api.v1.KubernetesServiceAccount) {
            Resource.Builder builder = Resource.newBuilder();
            builder.setKubernetesServiceAccount(convertKubernetesServiceAccountToPlumbing((com.strongdm.api.v1.KubernetesServiceAccount)porcelain));
            return builder.build();
        }
        ...
        if (porcelain instanceof com.strongdm.api.v1.AKSBasicAuth) {
            Resource.Builder builder = Resource.newBuilder();
            builder.setAksBasicAuth(convertAKSBasicAuthToPlumbing((com.strongdm.api.v1.AKSBasicAuth)porcelain));
            return builder.build();
        }
        if (porcelain instanceof com.strongdm.api.v1.AKSServiceAccount) {
            Resource.Builder builder = Resource.newBuilder();
            builder.setAksServiceAccount(convertAKSServiceAccountToPlumbing((com.strongdm.api.v1.AKSServiceAccount)porcelain));
            return builder.build();
        }
        ...
        if (porcelain instanceof com.strongdm.api.v1.MongoLegacyHost) {
            Resource.Builder builder = Resource.newBuilder();
            builder.setMongoLegacyHost(convertMongoLegacyHostToPlumbing((com.strongdm.api.v1.MongoLegacyHost)porcelain));
            return builder.build();
        }
        if (porcelain instanceof com.strongdm.api.v1.MongoLegacyReplicaset) {
            Resource.Builder builder = Resource.newBuilder();
            builder.setMongoLegacyReplicaset(convertMongoLegacyReplicasetToPlumbing((com.strongdm.api.v1.MongoLegacyReplicaset)porcelain));
            return builder.build();
        }
        ...
        if (porcelain instanceof com.strongdm.api.v1.MongoReplicaSet) {
            Resource.Builder builder = Resource.newBuilder();
            builder.setMongoReplicaSet(convertMongoReplicaSetToPlumbing((com.strongdm.api.v1.MongoReplicaSet)porcelain));
            return builder.build();
        }
        ...
        if (porcelain instanceof com.strongdm.api.v1.AuroraMysql) {
            Resource.Builder builder = Resource.newBuilder();
            builder.setAuroraMysql(convertAuroraMysqlToPlumbing((com.strongdm.api.v1.AuroraMysql)porcelain));
            return builder.build();
        }
        ...
        if (porcelain instanceof com.strongdm.api.v1.AuroraPostgres) {
            Resource.Builder builder = Resource.newBuilder();
            builder.setAuroraPostgres(convertAuroraPostgresToPlumbing((com.strongdm.api.v1.AuroraPostgres)porcelain));
            return builder.build();
        }
        ...
        if (porcelain instanceof com.strongdm.api.v1.ElasticacheRedis) {
            Resource.Builder builder = Resource.newBuilder();
            builder.setElasticacheRedis(convertElasticacheRedisToPlumbing((com.strongdm.api.v1.ElasticacheRedis)porcelain));
            return builder.build();
        }
    ...
    public static List<com.strongdm.api.v1.Resource> convertRepeatedResourceToPorcelain(Collection<Resource> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertResourceToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<Resource> convertRepeatedResourceToPlumbing(Collection<com.strongdm.api.v1.Resource> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.Athena> convertRepeatedAthenaToPorcelain(Collection<Athena> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertAthenaToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<Athena> convertRepeatedAthenaToPlumbing(Collection<com.strongdm.api.v1.Athena> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.BigQuery> convertRepeatedBigQueryToPorcelain(Collection<BigQuery> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertBigQueryToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<BigQuery> convertRepeatedBigQueryToPlumbing(Collection<com.strongdm.api.v1.BigQuery> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.Cassandra> convertRepeatedCassandraToPorcelain(Collection<Cassandra> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertCassandraToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<Cassandra> convertRepeatedCassandraToPlumbing(Collection<com.strongdm.api.v1.Cassandra> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.DB2I> convertRepeatedDB2IToPorcelain(Collection<DB2I> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertDB2IToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<DB2I> convertRepeatedDB2IToPlumbing(Collection<com.strongdm.api.v1.DB2I> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.DB2LUW> convertRepeatedDB2LUWToPorcelain(Collection<DB2LUW> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertDB2LUWToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<DB2LUW> convertRepeatedDB2LUWToPlumbing(Collection<com.strongdm.api.v1.DB2LUW> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.Druid> convertRepeatedDruidToPorcelain(Collection<Druid> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertDruidToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<Druid> convertRepeatedDruidToPlumbing(Collection<com.strongdm.api.v1.Druid> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.DynamoDB> convertRepeatedDynamoDBToPorcelain(Collection<DynamoDB> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertDynamoDBToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<DynamoDB> convertRepeatedDynamoDBToPlumbing(Collection<com.strongdm.api.v1.DynamoDB> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.AmazonES> convertRepeatedAmazonESToPorcelain(Collection<AmazonES> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertAmazonESToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<AmazonES> convertRepeatedAmazonESToPlumbing(Collection<com.strongdm.api.v1.AmazonES> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.Elastic> convertRepeatedElasticToPorcelain(Collection<Elastic> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertElasticToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<Elastic> convertRepeatedElasticToPlumbing(Collection<com.strongdm.api.v1.Elastic> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertElasticToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.HTTPBasicAuth convertHTTPBasicAuthToPorcelain(HTTPBasicAuth plumbing) {
    ...
    public static HTTPBasicAuth convertHTTPBasicAuthToPlumbing(com.strongdm.api.v1.HTTPBasicAuth porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.HTTPBasicAuth> convertRepeatedHTTPBasicAuthToPorcelain(Collection<HTTPBasicAuth> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertHTTPBasicAuthToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<HTTPBasicAuth> convertRepeatedHTTPBasicAuthToPlumbing(Collection<com.strongdm.api.v1.HTTPBasicAuth> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.HTTPNoAuth> convertRepeatedHTTPNoAuthToPorcelain(Collection<HTTPNoAuth> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertHTTPNoAuthToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<HTTPNoAuth> convertRepeatedHTTPNoAuthToPlumbing(Collection<com.strongdm.api.v1.HTTPNoAuth> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.HTTPAuth> convertRepeatedHTTPAuthToPorcelain(Collection<HTTPAuth> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertHTTPAuthToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<HTTPAuth> convertRepeatedHTTPAuthToPlumbing(Collection<com.strongdm.api.v1.HTTPAuth> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.Kubernetes> convertRepeatedKubernetesToPorcelain(Collection<Kubernetes> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertKubernetesToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<Kubernetes> convertRepeatedKubernetesToPlumbing(Collection<com.strongdm.api.v1.Kubernetes> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertKubernetesToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.KubernetesBasicAuth convertKubernetesBasicAuthToPorcelain(KubernetesBasicAuth plumbing) {
        com.strongdm.api.v1.KubernetesBasicAuth porcelain = new com.strongdm.api.v1.KubernetesBasicAuth();
        porcelain.setId((plumbing.getId()));
        porcelain.setName((plumbing.getName()));
        porcelain.setHealthy((plumbing.getHealthy()));
        porcelain.setTags(Plumbing.convertTagsToPorcelain(plumbing.getTags()));
    ...
    public static KubernetesBasicAuth convertKubernetesBasicAuthToPlumbing(com.strongdm.api.v1.KubernetesBasicAuth porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.KubernetesBasicAuth> convertRepeatedKubernetesBasicAuthToPorcelain(Collection<KubernetesBasicAuth> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertKubernetesBasicAuthToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<KubernetesBasicAuth> convertRepeatedKubernetesBasicAuthToPlumbing(Collection<com.strongdm.api.v1.KubernetesBasicAuth> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertKubernetesBasicAuthToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.KubernetesServiceAccount convertKubernetesServiceAccountToPorcelain(KubernetesServiceAccount plumbing) {
        com.strongdm.api.v1.KubernetesServiceAccount porcelain = new com.strongdm.api.v1.KubernetesServiceAccount();
        porcelain.setId((plumbing.getId()));
        porcelain.setName((plumbing.getName()));
        porcelain.setHealthy((plumbing.getHealthy()));
        porcelain.setTags(Plumbing.convertTagsToPorcelain(plumbing.getTags()));
    ...
    public static KubernetesServiceAccount convertKubernetesServiceAccountToPlumbing(com.strongdm.api.v1.KubernetesServiceAccount porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.KubernetesServiceAccount> convertRepeatedKubernetesServiceAccountToPorcelain(Collection<KubernetesServiceAccount> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertKubernetesServiceAccountToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<KubernetesServiceAccount> convertRepeatedKubernetesServiceAccountToPlumbing(Collection<com.strongdm.api.v1.KubernetesServiceAccount> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.AmazonEKS> convertRepeatedAmazonEKSToPorcelain(Collection<AmazonEKS> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertAmazonEKSToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<AmazonEKS> convertRepeatedAmazonEKSToPlumbing(Collection<com.strongdm.api.v1.AmazonEKS> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.GoogleGKE> convertRepeatedGoogleGKEToPorcelain(Collection<GoogleGKE> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertGoogleGKEToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<GoogleGKE> convertRepeatedGoogleGKEToPlumbing(Collection<com.strongdm.api.v1.GoogleGKE> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.AKS> convertRepeatedAKSToPorcelain(Collection<AKS> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertAKSToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<AKS> convertRepeatedAKSToPlumbing(Collection<com.strongdm.api.v1.AKS> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertAKSToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.AKSBasicAuth convertAKSBasicAuthToPorcelain(AKSBasicAuth plumbing) {
    ...
    public static AKSBasicAuth convertAKSBasicAuthToPlumbing(com.strongdm.api.v1.AKSBasicAuth porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.AKSBasicAuth> convertRepeatedAKSBasicAuthToPorcelain(Collection<AKSBasicAuth> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertAKSBasicAuthToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<AKSBasicAuth> convertRepeatedAKSBasicAuthToPlumbing(Collection<com.strongdm.api.v1.AKSBasicAuth> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertAKSBasicAuthToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.AKSServiceAccount convertAKSServiceAccountToPorcelain(AKSServiceAccount plumbing) {
    ...
    public static AKSServiceAccount convertAKSServiceAccountToPlumbing(com.strongdm.api.v1.AKSServiceAccount porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.AKSServiceAccount> convertRepeatedAKSServiceAccountToPorcelain(Collection<AKSServiceAccount> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertAKSServiceAccountToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<AKSServiceAccount> convertRepeatedAKSServiceAccountToPlumbing(Collection<com.strongdm.api.v1.AKSServiceAccount> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.Memcached> convertRepeatedMemcachedToPorcelain(Collection<Memcached> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertMemcachedToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<Memcached> convertRepeatedMemcachedToPlumbing(Collection<com.strongdm.api.v1.Memcached> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertMemcachedToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.MongoLegacyHost convertMongoLegacyHostToPorcelain(MongoLegacyHost plumbing) {
    ...
    public static MongoLegacyHost convertMongoLegacyHostToPlumbing(com.strongdm.api.v1.MongoLegacyHost porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.MongoLegacyHost> convertRepeatedMongoLegacyHostToPorcelain(Collection<MongoLegacyHost> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertMongoLegacyHostToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<MongoLegacyHost> convertRepeatedMongoLegacyHostToPlumbing(Collection<com.strongdm.api.v1.MongoLegacyHost> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertMongoLegacyHostToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.MongoLegacyReplicaset convertMongoLegacyReplicasetToPorcelain(MongoLegacyReplicaset plumbing) {
        com.strongdm.api.v1.MongoLegacyReplicaset porcelain = new com.strongdm.api.v1.MongoLegacyReplicaset();
        porcelain.setId((plumbing.getId()));
        porcelain.setName((plumbing.getName()));
        porcelain.setHealthy((plumbing.getHealthy()));
        porcelain.setTags(Plumbing.convertTagsToPorcelain(plumbing.getTags()));
    ...
    public static MongoLegacyReplicaset convertMongoLegacyReplicasetToPlumbing(com.strongdm.api.v1.MongoLegacyReplicaset porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.MongoLegacyReplicaset> convertRepeatedMongoLegacyReplicasetToPorcelain(Collection<MongoLegacyReplicaset> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertMongoLegacyReplicasetToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<MongoLegacyReplicaset> convertRepeatedMongoLegacyReplicasetToPlumbing(Collection<com.strongdm.api.v1.MongoLegacyReplicaset> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.MongoHost> convertRepeatedMongoHostToPorcelain(Collection<MongoHost> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertMongoHostToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<MongoHost> convertRepeatedMongoHostToPlumbing(Collection<com.strongdm.api.v1.MongoHost> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertMongoHostToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.MongoReplicaSet convertMongoReplicaSetToPorcelain(MongoReplicaSet plumbing) {
    ...
    public static MongoReplicaSet convertMongoReplicaSetToPlumbing(com.strongdm.api.v1.MongoReplicaSet porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.MongoReplicaSet> convertRepeatedMongoReplicaSetToPorcelain(Collection<MongoReplicaSet> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertMongoReplicaSetToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<MongoReplicaSet> convertRepeatedMongoReplicaSetToPlumbing(Collection<com.strongdm.api.v1.MongoReplicaSet> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.Mysql> convertRepeatedMysqlToPorcelain(Collection<Mysql> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertMysqlToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<Mysql> convertRepeatedMysqlToPlumbing(Collection<com.strongdm.api.v1.Mysql> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertMysqlToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.AuroraMysql convertAuroraMysqlToPorcelain(AuroraMysql plumbing) {
    ...
    public static AuroraMysql convertAuroraMysqlToPlumbing(com.strongdm.api.v1.AuroraMysql porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.AuroraMysql> convertRepeatedAuroraMysqlToPorcelain(Collection<AuroraMysql> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertAuroraMysqlToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<AuroraMysql> convertRepeatedAuroraMysqlToPlumbing(Collection<com.strongdm.api.v1.AuroraMysql> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.Clustrix> convertRepeatedClustrixToPorcelain(Collection<Clustrix> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertClustrixToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<Clustrix> convertRepeatedClustrixToPlumbing(Collection<com.strongdm.api.v1.Clustrix> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.Maria> convertRepeatedMariaToPorcelain(Collection<Maria> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertMariaToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<Maria> convertRepeatedMariaToPlumbing(Collection<com.strongdm.api.v1.Maria> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.Memsql> convertRepeatedMemsqlToPorcelain(Collection<Memsql> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertMemsqlToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<Memsql> convertRepeatedMemsqlToPlumbing(Collection<com.strongdm.api.v1.Memsql> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.Oracle> convertRepeatedOracleToPorcelain(Collection<Oracle> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertOracleToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<Oracle> convertRepeatedOracleToPlumbing(Collection<com.strongdm.api.v1.Oracle> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.Postgres> convertRepeatedPostgresToPorcelain(Collection<Postgres> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertPostgresToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<Postgres> convertRepeatedPostgresToPlumbing(Collection<com.strongdm.api.v1.Postgres> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertPostgresToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.AuroraPostgres convertAuroraPostgresToPorcelain(AuroraPostgres plumbing) {
    ...
    public static AuroraPostgres convertAuroraPostgresToPlumbing(com.strongdm.api.v1.AuroraPostgres porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.AuroraPostgres> convertRepeatedAuroraPostgresToPorcelain(Collection<AuroraPostgres> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertAuroraPostgresToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<AuroraPostgres> convertRepeatedAuroraPostgresToPlumbing(Collection<com.strongdm.api.v1.AuroraPostgres> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.Greenplum> convertRepeatedGreenplumToPorcelain(Collection<Greenplum> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertGreenplumToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<Greenplum> convertRepeatedGreenplumToPlumbing(Collection<com.strongdm.api.v1.Greenplum> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.Cockroach> convertRepeatedCockroachToPorcelain(Collection<Cockroach> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertCockroachToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<Cockroach> convertRepeatedCockroachToPlumbing(Collection<com.strongdm.api.v1.Cockroach> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.Redshift> convertRepeatedRedshiftToPorcelain(Collection<Redshift> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertRedshiftToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<Redshift> convertRepeatedRedshiftToPlumbing(Collection<com.strongdm.api.v1.Redshift> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.Citus> convertRepeatedCitusToPorcelain(Collection<Citus> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertCitusToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<Citus> convertRepeatedCitusToPlumbing(Collection<com.strongdm.api.v1.Citus> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.Presto> convertRepeatedPrestoToPorcelain(Collection<Presto> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertPrestoToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<Presto> convertRepeatedPrestoToPlumbing(Collection<com.strongdm.api.v1.Presto> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.RDP> convertRepeatedRDPToPorcelain(Collection<RDP> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertRDPToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<RDP> convertRepeatedRDPToPlumbing(Collection<com.strongdm.api.v1.RDP> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.Redis> convertRepeatedRedisToPorcelain(Collection<Redis> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertRedisToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<Redis> convertRepeatedRedisToPlumbing(Collection<com.strongdm.api.v1.Redis> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertRedisToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.ElasticacheRedis convertElasticacheRedisToPorcelain(ElasticacheRedis plumbing) {
    ...
    public static ElasticacheRedis convertElasticacheRedisToPlumbing(com.strongdm.api.v1.ElasticacheRedis porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.ElasticacheRedis> convertRepeatedElasticacheRedisToPorcelain(Collection<ElasticacheRedis> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertElasticacheRedisToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<ElasticacheRedis> convertRepeatedElasticacheRedisToPlumbing(Collection<com.strongdm.api.v1.ElasticacheRedis> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.Snowflake> convertRepeatedSnowflakeToPorcelain(Collection<Snowflake> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertSnowflakeToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<Snowflake> convertRepeatedSnowflakeToPlumbing(Collection<com.strongdm.api.v1.Snowflake> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.SQLServer> convertRepeatedSQLServerToPorcelain(Collection<SQLServer> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertSQLServerToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<SQLServer> convertRepeatedSQLServerToPlumbing(Collection<com.strongdm.api.v1.SQLServer> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.SSH> convertRepeatedSSHToPorcelain(Collection<SSH> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertSSHToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<SSH> convertRepeatedSSHToPlumbing(Collection<com.strongdm.api.v1.SSH> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.SSHCert> convertRepeatedSSHCertToPorcelain(Collection<SSHCert> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertSSHCertToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<SSHCert> convertRepeatedSSHCertToPlumbing(Collection<com.strongdm.api.v1.SSHCert> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.Sybase> convertRepeatedSybaseToPorcelain(Collection<Sybase> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertSybaseToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<Sybase> convertRepeatedSybaseToPlumbing(Collection<com.strongdm.api.v1.Sybase> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.SybaseIQ> convertRepeatedSybaseIQToPorcelain(Collection<SybaseIQ> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertSybaseIQToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<SybaseIQ> convertRepeatedSybaseIQToPlumbing(Collection<com.strongdm.api.v1.SybaseIQ> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.Teradata> convertRepeatedTeradataToPorcelain(Collection<Teradata> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertTeradataToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<Teradata> convertRepeatedTeradataToPlumbing(Collection<com.strongdm.api.v1.Teradata> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertTeradataToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.NodeCreateResponse convertNodeCreateResponseToPorcelain(NodeCreateResponse plumbing) {
    ...
    public static NodeCreateResponse convertNodeCreateResponseToPlumbing(com.strongdm.api.v1.NodeCreateResponse porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.NodeCreateResponse> convertRepeatedNodeCreateResponseToPorcelain(Collection<NodeCreateResponse> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertNodeCreateResponseToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<NodeCreateResponse> convertRepeatedNodeCreateResponseToPlumbing(Collection<com.strongdm.api.v1.NodeCreateResponse> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertNodeCreateResponseToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.NodeGetResponse convertNodeGetResponseToPorcelain(NodeGetResponse plumbing) {
    ...
    public static NodeGetResponse convertNodeGetResponseToPlumbing(com.strongdm.api.v1.NodeGetResponse porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.NodeGetResponse> convertRepeatedNodeGetResponseToPorcelain(Collection<NodeGetResponse> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertNodeGetResponseToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<NodeGetResponse> convertRepeatedNodeGetResponseToPlumbing(Collection<com.strongdm.api.v1.NodeGetResponse> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertNodeGetResponseToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.NodeUpdateResponse convertNodeUpdateResponseToPorcelain(NodeUpdateResponse plumbing) {
    ...
    public static NodeUpdateResponse convertNodeUpdateResponseToPlumbing(com.strongdm.api.v1.NodeUpdateResponse porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.NodeUpdateResponse> convertRepeatedNodeUpdateResponseToPorcelain(Collection<NodeUpdateResponse> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertNodeUpdateResponseToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<NodeUpdateResponse> convertRepeatedNodeUpdateResponseToPlumbing(Collection<com.strongdm.api.v1.NodeUpdateResponse> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertNodeUpdateResponseToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.NodeDeleteResponse convertNodeDeleteResponseToPorcelain(NodeDeleteResponse plumbing) {
    ...
    public static NodeDeleteResponse convertNodeDeleteResponseToPlumbing(com.strongdm.api.v1.NodeDeleteResponse porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.NodeDeleteResponse> convertRepeatedNodeDeleteResponseToPorcelain(Collection<NodeDeleteResponse> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertNodeDeleteResponseToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<NodeDeleteResponse> convertRepeatedNodeDeleteResponseToPlumbing(Collection<com.strongdm.api.v1.NodeDeleteResponse> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.Node> convertRepeatedNodeToPorcelain(Collection<Node> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertNodeToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<Node> convertRepeatedNodeToPlumbing(Collection<com.strongdm.api.v1.Node> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.Relay> convertRepeatedRelayToPorcelain(Collection<Relay> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertRelayToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<Relay> convertRepeatedRelayToPlumbing(Collection<com.strongdm.api.v1.Relay> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.Gateway> convertRepeatedGatewayToPorcelain(Collection<Gateway> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertGatewayToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<Gateway> convertRepeatedGatewayToPlumbing(Collection<com.strongdm.api.v1.Gateway> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertGatewayToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.ResourceCreateResponse convertResourceCreateResponseToPorcelain(ResourceCreateResponse plumbing) {
        com.strongdm.api.v1.ResourceCreateResponse porcelain = new com.strongdm.api.v1.ResourceCreateResponse();
        porcelain.setMeta(Plumbing.convertCreateResponseMetadataToPorcelain(plumbing.getMeta()));
    ...
    public static ResourceCreateResponse convertResourceCreateResponseToPlumbing(com.strongdm.api.v1.ResourceCreateResponse porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.ResourceCreateResponse> convertRepeatedResourceCreateResponseToPorcelain(Collection<ResourceCreateResponse> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertResourceCreateResponseToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<ResourceCreateResponse> convertRepeatedResourceCreateResponseToPlumbing(Collection<com.strongdm.api.v1.ResourceCreateResponse> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertResourceCreateResponseToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.ResourceGetResponse convertResourceGetResponseToPorcelain(ResourceGetResponse plumbing) {
        com.strongdm.api.v1.ResourceGetResponse porcelain = new com.strongdm.api.v1.ResourceGetResponse();
        porcelain.setMeta(Plumbing.convertGetResponseMetadataToPorcelain(plumbing.getMeta()));
        porcelain.setResource(Plumbing.convertResourceToPorcelain(plumbing.getResource()));
        porcelain.setRateLimit(Plumbing.convertRateLimitMetadataToPorcelain(plumbing.getRateLimit()));
        return porcelain;
    ...
    public static ResourceGetResponse convertResourceGetResponseToPlumbing(com.strongdm.api.v1.ResourceGetResponse porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.ResourceGetResponse> convertRepeatedResourceGetResponseToPorcelain(Collection<ResourceGetResponse> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertResourceGetResponseToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<ResourceGetResponse> convertRepeatedResourceGetResponseToPlumbing(Collection<com.strongdm.api.v1.ResourceGetResponse> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertResourceGetResponseToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.ResourceUpdateResponse convertResourceUpdateResponseToPorcelain(ResourceUpdateResponse plumbing) {
        com.strongdm.api.v1.ResourceUpdateResponse porcelain = new com.strongdm.api.v1.ResourceUpdateResponse();
        porcelain.setMeta(Plumbing.convertUpdateResponseMetadataToPorcelain(plumbing.getMeta()));
        porcelain.setResource(Plumbing.convertResourceToPorcelain(plumbing.getResource()));
        porcelain.setRateLimit(Plumbing.convertRateLimitMetadataToPorcelain(plumbing.getRateLimit()));
        return porcelain;
    ...
    public static ResourceUpdateResponse convertResourceUpdateResponseToPlumbing(com.strongdm.api.v1.ResourceUpdateResponse porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.ResourceUpdateResponse> convertRepeatedResourceUpdateResponseToPorcelain(Collection<ResourceUpdateResponse> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertResourceUpdateResponseToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<ResourceUpdateResponse> convertRepeatedResourceUpdateResponseToPlumbing(Collection<com.strongdm.api.v1.ResourceUpdateResponse> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertResourceUpdateResponseToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.ResourceDeleteResponse convertResourceDeleteResponseToPorcelain(ResourceDeleteResponse plumbing) {
        com.strongdm.api.v1.ResourceDeleteResponse porcelain = new com.strongdm.api.v1.ResourceDeleteResponse();
        porcelain.setMeta(Plumbing.convertDeleteResponseMetadataToPorcelain(plumbing.getMeta()));
        porcelain.setRateLimit(Plumbing.convertRateLimitMetadataToPorcelain(plumbing.getRateLimit()));
        return porcelain;
    }

    public static ResourceDeleteResponse convertResourceDeleteResponseToPlumbing(com.strongdm.api.v1.ResourceDeleteResponse porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.ResourceDeleteResponse> convertRepeatedResourceDeleteResponseToPorcelain(Collection<ResourceDeleteResponse> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertResourceDeleteResponseToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<ResourceDeleteResponse> convertRepeatedResourceDeleteResponseToPlumbing(Collection<com.strongdm.api.v1.ResourceDeleteResponse> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertResourceDeleteResponseToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.RoleAttachmentCreateResponse convertRoleAttachmentCreateResponseToPorcelain(RoleAttachmentCreateResponse plumbing) {
        com.strongdm.api.v1.RoleAttachmentCreateResponse porcelain = new com.strongdm.api.v1.RoleAttachmentCreateResponse();
        porcelain.setMeta(Plumbing.convertCreateResponseMetadataToPorcelain(plumbing.getMeta()));
        porcelain.setRoleAttachment(Plumbing.convertRoleAttachmentToPorcelain(plumbing.getRoleAttachment()));
        porcelain.setRateLimit(Plumbing.convertRateLimitMetadataToPorcelain(plumbing.getRateLimit()));
        return porcelain;
    }

    public static RoleAttachmentCreateResponse convertRoleAttachmentCreateResponseToPlumbing(com.strongdm.api.v1.RoleAttachmentCreateResponse porcelain) {
        if (porcelain == null) {
            return null;
        }
        ...
        if (porcelain.getRoleAttachment() != null) {
            builder.setRoleAttachment(Plumbing.convertRoleAttachmentToPlumbing(porcelain.getRoleAttachment()));
        }
        if (porcelain.getRateLimit() != null) {
            builder.setRateLimit(Plumbing.convertRateLimitMetadataToPlumbing(porcelain.getRateLimit()));
        }
    ...
    public static List<com.strongdm.api.v1.RoleAttachmentCreateResponse> convertRepeatedRoleAttachmentCreateResponseToPorcelain(Collection<RoleAttachmentCreateResponse> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertRoleAttachmentCreateResponseToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<RoleAttachmentCreateResponse> convertRepeatedRoleAttachmentCreateResponseToPlumbing(Collection<com.strongdm.api.v1.RoleAttachmentCreateResponse> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertRoleAttachmentCreateResponseToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.RoleAttachmentGetResponse convertRoleAttachmentGetResponseToPorcelain(RoleAttachmentGetResponse plumbing) {
        com.strongdm.api.v1.RoleAttachmentGetResponse porcelain = new com.strongdm.api.v1.RoleAttachmentGetResponse();
        porcelain.setMeta(Plumbing.convertGetResponseMetadataToPorcelain(plumbing.getMeta()));
        porcelain.setRoleAttachment(Plumbing.convertRoleAttachmentToPorcelain(plumbing.getRoleAttachment()));
        porcelain.setRateLimit(Plumbing.convertRateLimitMetadataToPorcelain(plumbing.getRateLimit()));
        return porcelain;
    ...
    public static RoleAttachmentGetResponse convertRoleAttachmentGetResponseToPlumbing(com.strongdm.api.v1.RoleAttachmentGetResponse porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.RoleAttachmentGetResponse> convertRepeatedRoleAttachmentGetResponseToPorcelain(Collection<RoleAttachmentGetResponse> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertRoleAttachmentGetResponseToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<RoleAttachmentGetResponse> convertRepeatedRoleAttachmentGetResponseToPlumbing(Collection<com.strongdm.api.v1.RoleAttachmentGetResponse> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertRoleAttachmentGetResponseToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.RoleAttachmentDeleteResponse convertRoleAttachmentDeleteResponseToPorcelain(RoleAttachmentDeleteResponse plumbing) {
        com.strongdm.api.v1.RoleAttachmentDeleteResponse porcelain = new com.strongdm.api.v1.RoleAttachmentDeleteResponse();
        porcelain.setMeta(Plumbing.convertDeleteResponseMetadataToPorcelain(plumbing.getMeta()));
        porcelain.setRateLimit(Plumbing.convertRateLimitMetadataToPorcelain(plumbing.getRateLimit()));
        return porcelain;
    }

    public static RoleAttachmentDeleteResponse convertRoleAttachmentDeleteResponseToPlumbing(com.strongdm.api.v1.RoleAttachmentDeleteResponse porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.RoleAttachmentDeleteResponse> convertRepeatedRoleAttachmentDeleteResponseToPorcelain(Collection<RoleAttachmentDeleteResponse> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertRoleAttachmentDeleteResponseToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<RoleAttachmentDeleteResponse> convertRepeatedRoleAttachmentDeleteResponseToPlumbing(Collection<com.strongdm.api.v1.RoleAttachmentDeleteResponse> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertRoleAttachmentDeleteResponseToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.RoleAttachment convertRoleAttachmentToPorcelain(RoleAttachment plumbing) {
    ...
    public static RoleAttachment convertRoleAttachmentToPlumbing(com.strongdm.api.v1.RoleAttachment porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.RoleAttachment> convertRepeatedRoleAttachmentToPorcelain(Collection<RoleAttachment> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertRoleAttachmentToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<RoleAttachment> convertRepeatedRoleAttachmentToPlumbing(Collection<com.strongdm.api.v1.RoleAttachment> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertRoleAttachmentToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.RoleGrantCreateResponse convertRoleGrantCreateResponseToPorcelain(RoleGrantCreateResponse plumbing) {
        com.strongdm.api.v1.RoleGrantCreateResponse porcelain = new com.strongdm.api.v1.RoleGrantCreateResponse();
        porcelain.setMeta(Plumbing.convertCreateResponseMetadataToPorcelain(plumbing.getMeta()));
    ...
    public static RoleGrantCreateResponse convertRoleGrantCreateResponseToPlumbing(com.strongdm.api.v1.RoleGrantCreateResponse porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.RoleGrantCreateResponse> convertRepeatedRoleGrantCreateResponseToPorcelain(Collection<RoleGrantCreateResponse> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertRoleGrantCreateResponseToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<RoleGrantCreateResponse> convertRepeatedRoleGrantCreateResponseToPlumbing(Collection<com.strongdm.api.v1.RoleGrantCreateResponse> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertRoleGrantCreateResponseToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.RoleGrantGetResponse convertRoleGrantGetResponseToPorcelain(RoleGrantGetResponse plumbing) {
        com.strongdm.api.v1.RoleGrantGetResponse porcelain = new com.strongdm.api.v1.RoleGrantGetResponse();
        porcelain.setMeta(Plumbing.convertGetResponseMetadataToPorcelain(plumbing.getMeta()));
        porcelain.setRoleGrant(Plumbing.convertRoleGrantToPorcelain(plumbing.getRoleGrant()));
        porcelain.setRateLimit(Plumbing.convertRateLimitMetadataToPorcelain(plumbing.getRateLimit()));
        return porcelain;
    ...
    public static RoleGrantGetResponse convertRoleGrantGetResponseToPlumbing(com.strongdm.api.v1.RoleGrantGetResponse porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.RoleGrantGetResponse> convertRepeatedRoleGrantGetResponseToPorcelain(Collection<RoleGrantGetResponse> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertRoleGrantGetResponseToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<RoleGrantGetResponse> convertRepeatedRoleGrantGetResponseToPlumbing(Collection<com.strongdm.api.v1.RoleGrantGetResponse> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertRoleGrantGetResponseToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.RoleGrantDeleteResponse convertRoleGrantDeleteResponseToPorcelain(RoleGrantDeleteResponse plumbing) {
        com.strongdm.api.v1.RoleGrantDeleteResponse porcelain = new com.strongdm.api.v1.RoleGrantDeleteResponse();
        porcelain.setMeta(Plumbing.convertDeleteResponseMetadataToPorcelain(plumbing.getMeta()));
        porcelain.setRateLimit(Plumbing.convertRateLimitMetadataToPorcelain(plumbing.getRateLimit()));
        return porcelain;
    }

    public static RoleGrantDeleteResponse convertRoleGrantDeleteResponseToPlumbing(com.strongdm.api.v1.RoleGrantDeleteResponse porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.RoleGrantDeleteResponse> convertRepeatedRoleGrantDeleteResponseToPorcelain(Collection<RoleGrantDeleteResponse> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertRoleGrantDeleteResponseToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<RoleGrantDeleteResponse> convertRepeatedRoleGrantDeleteResponseToPlumbing(Collection<com.strongdm.api.v1.RoleGrantDeleteResponse> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.RoleGrant> convertRepeatedRoleGrantToPorcelain(Collection<RoleGrant> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertRoleGrantToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<RoleGrant> convertRepeatedRoleGrantToPlumbing(Collection<com.strongdm.api.v1.RoleGrant> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertRoleGrantToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.RoleCreateResponse convertRoleCreateResponseToPorcelain(RoleCreateResponse plumbing) {
    ...
    public static RoleCreateResponse convertRoleCreateResponseToPlumbing(com.strongdm.api.v1.RoleCreateResponse porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.RoleCreateResponse> convertRepeatedRoleCreateResponseToPorcelain(Collection<RoleCreateResponse> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertRoleCreateResponseToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<RoleCreateResponse> convertRepeatedRoleCreateResponseToPlumbing(Collection<com.strongdm.api.v1.RoleCreateResponse> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertRoleCreateResponseToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.RoleGetResponse convertRoleGetResponseToPorcelain(RoleGetResponse plumbing) {
    ...
    public static RoleGetResponse convertRoleGetResponseToPlumbing(com.strongdm.api.v1.RoleGetResponse porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.RoleGetResponse> convertRepeatedRoleGetResponseToPorcelain(Collection<RoleGetResponse> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertRoleGetResponseToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<RoleGetResponse> convertRepeatedRoleGetResponseToPlumbing(Collection<com.strongdm.api.v1.RoleGetResponse> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertRoleGetResponseToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.RoleUpdateResponse convertRoleUpdateResponseToPorcelain(RoleUpdateResponse plumbing) {
    ...
    public static RoleUpdateResponse convertRoleUpdateResponseToPlumbing(com.strongdm.api.v1.RoleUpdateResponse porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.RoleUpdateResponse> convertRepeatedRoleUpdateResponseToPorcelain(Collection<RoleUpdateResponse> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertRoleUpdateResponseToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<RoleUpdateResponse> convertRepeatedRoleUpdateResponseToPlumbing(Collection<com.strongdm.api.v1.RoleUpdateResponse> porcelains) {
        return porcelains.stream()
            .map(porcelain -> convertRoleUpdateResponseToPlumbing(porcelain))
            .collect(Collectors.toList());
    }
    public static com.strongdm.api.v1.RoleDeleteResponse convertRoleDeleteResponseToPorcelain(RoleDeleteResponse plumbing) {
    ...
    public static RoleDeleteResponse convertRoleDeleteResponseToPlumbing(com.strongdm.api.v1.RoleDeleteResponse porcelain) {
        if (porcelain == null) {
            return null;
        }
    ...
    public static List<com.strongdm.api.v1.RoleDeleteResponse> convertRepeatedRoleDeleteResponseToPorcelain(Collection<RoleDeleteResponse> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertRoleDeleteResponseToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<RoleDeleteResponse> convertRepeatedRoleDeleteResponseToPlumbing(Collection<com.strongdm.api.v1.RoleDeleteResponse> porcelains) {
        return porcelains.stream()
    ...
    public static List<com.strongdm.api.v1.Role> convertRepeatedRoleToPorcelain(Collection<Role> plumbings) {
        return plumbings.stream()
            .map(plumbing -> convertRoleToPorcelain(plumbing))
            .collect(Collectors.toList());
    }

    public static List<Role> convertRepeatedRoleToPlumbing(Collection<com.strongdm.api.v1.Role> porcelains) {
        return porcelains.stream()
                ...
                try {
                    for (com.google.protobuf.Any any : status.getDetailsList()) {
                        if (any.is(com.strongdm.api.v1.plumbing.Spec.RateLimitMetadata.class)) {
                            ...
                            return new com.strongdm.api.v1.RateLimitException(e.getMessage(), Plumbing.convertRateLimitMetadataToPorcelain(plumbing));
                        }
                    }
