...
public final class RoleGrantsGrpc {
  ...
  public static io.grpc.MethodDescriptor<
    ...
    if ((getCreateMethod = RoleGrantsGrpc.getCreateMethod) == null) {
      synchronized (RoleGrantsGrpc.class) {
        if ((getCreateMethod = RoleGrantsGrpc.getCreateMethod) == null) {
          RoleGrantsGrpc.getCreateMethod =
              getCreateMethod =
                  io.grpc.MethodDescriptor
                      .<com.strongdm.api.v1.plumbing.RoleGrantsPlumbing.RoleGrantCreateRequest,
                          com.strongdm.api.v1.plumbing.RoleGrantsPlumbing.RoleGrantCreateResponse>
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.strongdm.api.v1.plumbing.RoleGrantsPlumbing
                                  .RoleGrantCreateResponse.getDefaultInstance()))
  ...
  public static io.grpc.MethodDescriptor<
    ...
    if ((getDeleteMethod = RoleGrantsGrpc.getDeleteMethod) == null) {
      synchronized (RoleGrantsGrpc.class) {
        if ((getDeleteMethod = RoleGrantsGrpc.getDeleteMethod) == null) {
          RoleGrantsGrpc.getDeleteMethod =
              getDeleteMethod =
                  io.grpc.MethodDescriptor
                      .<com.strongdm.api.v1.plumbing.RoleGrantsPlumbing.RoleGrantDeleteRequest,
                          com.strongdm.api.v1.plumbing.RoleGrantsPlumbing.RoleGrantDeleteResponse>
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.strongdm.api.v1.plumbing.RoleGrantsPlumbing
                                  .RoleGrantDeleteResponse.getDefaultInstance()))
   ...
   */
  public static RoleGrantsBlockingStub newBlockingStub(io.grpc.Channel channel) {
    return new RoleGrantsBlockingStub(channel);
  }

  /** Creates a new ListenableFuture-style stub that supports unary calls on the service */
  public static RoleGrantsFutureStub newFutureStub(io.grpc.Channel channel) {
   ...
   * </pre>
   */
  public abstract static class RoleGrantsImplBase implements io.grpc.BindableService {
  ...
  public static final class RoleGrantsStub extends io.grpc.stub.AbstractStub<RoleGrantsStub> {
    ...
    private RoleGrantsStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected RoleGrantsStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   * </pre>
   */
  public static final class RoleGrantsBlockingStub
      extends io.grpc.stub.AbstractStub<RoleGrantsBlockingStub> {
    private RoleGrantsBlockingStub(io.grpc.Channel channel) {
      super(channel);
    }

    private RoleGrantsBlockingStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
     ...
     * </pre>
     */
    public com.strongdm.api.v1.plumbing.RoleGrantsPlumbing.RoleGrantCreateResponse create(
        com.strongdm.api.v1.plumbing.RoleGrantsPlumbing.RoleGrantCreateRequest request) {
     ...
     * </pre>
     */
    public com.strongdm.api.v1.plumbing.RoleGrantsPlumbing.RoleGrantGetResponse get(
        com.strongdm.api.v1.plumbing.RoleGrantsPlumbing.RoleGrantGetRequest request) {
     ...
     * </pre>
     */
    public com.strongdm.api.v1.plumbing.RoleGrantsPlumbing.RoleGrantDeleteResponse delete(
        com.strongdm.api.v1.plumbing.RoleGrantsPlumbing.RoleGrantDeleteRequest request) {
     ...
     * </pre>
     */
    public com.strongdm.api.v1.plumbing.RoleGrantsPlumbing.RoleGrantListResponse list(
        com.strongdm.api.v1.plumbing.RoleGrantsPlumbing.RoleGrantListRequest request) {
   ...
   * </pre>
   */
  public static final class RoleGrantsFutureStub
      extends io.grpc.stub.AbstractStub<RoleGrantsFutureStub> {
    private RoleGrantsFutureStub(io.grpc.Channel channel) {
      super(channel);
    }

    private RoleGrantsFutureStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected RoleGrantsFutureStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.strongdm.api.v1.plumbing.RoleGrantsPlumbing.RoleGrantCreateResponse>
        create(com.strongdm.api.v1.plumbing.RoleGrantsPlumbing.RoleGrantCreateRequest request) {
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.strongdm.api.v1.plumbing.RoleGrantsPlumbing.RoleGrantGetResponse>
        get(com.strongdm.api.v1.plumbing.RoleGrantsPlumbing.RoleGrantGetRequest request) {
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.strongdm.api.v1.plumbing.RoleGrantsPlumbing.RoleGrantDeleteResponse>
        delete(com.strongdm.api.v1.plumbing.RoleGrantsPlumbing.RoleGrantDeleteRequest request) {
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.strongdm.api.v1.plumbing.RoleGrantsPlumbing.RoleGrantListResponse>
        list(com.strongdm.api.v1.plumbing.RoleGrantsPlumbing.RoleGrantListRequest request) {
  ...
  private abstract static class RoleGrantsBaseDescriptorSupplier
