...
/**
 * GroupHistory records the state of a Group at a given point in time, where every change (create,
 * update and delete) to a Group produces a GroupHistory record.
 */
public class GroupHistory {
  private String activityId;
  /**
   * The unique identifier of the Activity that produced this change to the Group. May be empty for
